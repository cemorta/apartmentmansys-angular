...
@Component({
  selector: 'app-admin-maintenance-request-list',
  standalone: false,
  templateUrl: './admin-maintenance-request-list.component.html',
  styleUrl: './admin-maintenance-request-list.component.css'
})

export class AdminMaintenanceRequestListComponent implements OnInit {
  ...
  loadMaintenanceRequests(): void {
    ...
    this.maintenanceRequestService.getMaintenanceRequests(filters).subscribe(response => {
      this.maintenanceRequests = response.content;
