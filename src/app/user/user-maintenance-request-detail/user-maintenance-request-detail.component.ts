...
@Component({
  selector: 'user-maintenance-request-detail',
  standalone: false,
  templateUrl: './user-maintenance-request-detail.component.html',
  styleUrl: './user-maintenance-request-detail.component.css'
})
export class UserMaintenanceRequestDetailComponent implements OnInit {
